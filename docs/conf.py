...
# -*- coding: utf-8 -*-
#
# parsel-cli documentation build configuration file, created by
...
htmlhelp_basename = 'parsel_clidoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'parsel_cli.tex',
     u'Parsel CLI Documentation',
